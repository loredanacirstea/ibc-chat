...
const baseQueryGetMessageRequest = { id: 0 };
export const QueryGetMessageRequest = {
    ...
    decode(input, length) {
        const reader = input instanceof Uint8Array ? new Reader(input) : input;
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseQueryGetMessageRequest };
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
const baseQueryGetMessageResponse = {};
...
const baseQueryAllMessageRequest = {};
export const QueryAllMessageRequest = {
    ...
    decode(input, length) {
        const reader = input instanceof Uint8Array ? new Reader(input) : input;
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseQueryAllMessageRequest };
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
const baseQueryAllMessageResponse = {};
...
export class QueryClientImpl {
    ...
    Params(request) {
        ...
        const promise = this.rpc.request("loredanacirstea.chat.chat.Query", "Params", data);
        return promise.then((data) => QueryParamsResponse.decode(new Reader(data)));
    }
    Message(request) {
        const data = QueryGetMessageRequest.encode(request).finish();
        const promise = this.rpc.request("loredanacirstea.chat.chat.Query", "Message", data);
        return promise.then((data) => QueryGetMessageResponse.decode(new Reader(data)));
    }
    MessageAll(request) {
        const data = QueryAllMessageRequest.encode(request).finish();
        const promise = this.rpc.request("loredanacirstea.chat.chat.Query", "MessageAll", data);
        return promise.then((data) => QueryAllMessageResponse.decode(new Reader(data)));
    }
}
var globalThis = (() => {
