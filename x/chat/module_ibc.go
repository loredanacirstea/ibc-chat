...
func (am AppModule) OnRecvPacket(
	...
	case *types.ChatPacketData_SpaceMessagePacket:
		packetAck, err := am.keeper.OnRecvSpaceMessagePacket(ctx, modulePacket, *packet.SpaceMessagePacket)
		if err != nil {
		...
		ctx.EventManager().EmitEvent(
			sdk.NewEvent(
				types.EventTypeSpaceMessagePacket,
...
func (am AppModule) OnAcknowledgementPacket(
	...
	switch packet := modulePacketData.Packet.(type) {
	case *types.ChatPacketData_SpaceMessagePacket:
		err := am.keeper.OnAcknowledgementSpaceMessagePacket(ctx, modulePacket, *packet.SpaceMessagePacket, ack)
		if err != nil {
			return err
		}
		eventType = types.EventTypeSpaceMessagePacket
...
func (am AppModule) OnTimeoutPacket(
	...
	switch packet := modulePacketData.Packet.(type) {
	case *types.ChatPacketData_SpaceMessagePacket:
		err := am.keeper.OnTimeoutSpaceMessagePacket(ctx, modulePacket, *packet.SpaceMessagePacket)
		if err != nil {
			return err
		}
